...
def merge(img_ids, eval_imgs):
    all_img_ids = misc.all_gather(img_ids)
    all_eval_imgs = misc.all_gather(eval_imgs)
...
# NOTE: We had to copy this function from COCO.loadRes() because there is a line
#       "bb = ann['bbox']" which does index the boxes with the way this repo stores them
#       This copied from changes the line to
#       "bb = ann['bbox'][0]""
